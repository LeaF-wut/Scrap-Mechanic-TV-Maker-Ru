...
(function() {
  window.getFusion = function() {
    var fused, name, one, prefix, select1, select2, share_example, share_text, suffix, two, url;
    fused = $("#fused")[0];
    select1 = $("#select1")[0];
    select2 = $("#select2")[0];
    one = select1[select1.selectedIndex].value;
    two = select2[select2.selectedIndex].value;
    prefix = $("#hiddenprefix")[0][select1.selectedIndex].text;
    suffix = $("#hiddensuffix")[0][select2.selectedIndex].text;
    ...
    url = $("#url")[0].innerHTML;
    share_text = $("#share_text")[0].innerHTML;
    share_example = $("#share_example")[0].innerHTML;
    $("#tw_share").click(function() {
      return share_btn("https://twitter.com/share?text=" + share_text + share_example + name + ": " + "&url=" + escape(url + "/" + one + "/" + two));
    });
    $("#fb_share").click(function() {
      return share_btn("https://www.facebook.com/sharer/sharer.php?u=" + url + "/" + one + "/" + two);
    });
    return $("#permalink")[0].value = url + "/" + one + "/" + two;
  };

  window.shareInit = function() {
    var name, one, prefix, share_example, share_text, suffix, two, url;
    one = select1[select1.selectedIndex].value;
    two = select2[select2.selectedIndex].value;
    prefix = $("#hiddenprefix")[0][select1.selectedIndex].text;
    suffix = $("#hiddensuffix")[0][select2.selectedIndex].text;
  ...
  window.swap = function() {
    ...
    select1 = $("#select1")[0];
    select2 = $("#select2")[0];
    return pokego(select2.selectedIndex + 1, select1.selectedIndex + 1);
  };
  ...
  window.share_btn = function(href) {
    window.open(href, 'sharer', 'toolbar=0,status=0,width=600,height=400');
    return false;
  };
...
(function($) {
    ...
    var config = {
		...
		$('body').append("<div id='jquery-dropper-hover-chip' style='width:15px; height: 15px; border: 1px solid #000; display:none'> </div>");
